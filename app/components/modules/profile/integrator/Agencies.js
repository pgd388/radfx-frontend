...
const columns = [
  {
    field: 'full_name', headerName: 'Agency', flex: 1,
    editable: false,
  },
  {
...
const agencies = [
  { id: 0, full_name: 'Joe Bloe', email: 'email@email.com', phone: '000-000-0000' },
];
    ...
    <>
      <Container maxWidth="lg" style={{ paddingTop: '1rem' }}>
        <Grid container rowSpacing={4} columnSpacing={{ xs: 2, sm: 3, md: 4 }}>
          ...
          <Grid item xs={3} >
            <Button sx={{ alignItems: 'center' }} variant="contained" id="button-create-agency" disableElevation>
              Create Agency
            </Button>
          </Grid>
          <Grid item xs={12}>
